                ...
                <Form {...form}>
                    <form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
                        <FormField control={form.control} name="description" render={({ field }) => (<FormItem>
                            ...
                            <FormDescription>Transaction description(optional)
                            </FormDescription>
                        </FormItem>
                        )}>
                        </FormField>
                        ...
                        <FormField control={form.control} name="amount" render={({ field }) => (<FormItem>
                            ...
                            <FormDescription>Transaction amount(required)
                            </FormDescription>
                        </FormItem>
                        )}>
                        </FormField>
                        Transaction:{form.watch("category")}
                        <div className="flex item-center justify-between gap-2 z-1">
                            <FormField control={form.control} name="category" render={({ field }) => (<FormItem>
                                <FormLabel>Category</FormLabel>
                                <FormControl>
                                    <CategoryPicker type={type} onChange={handleCategoryChange} />
                                </FormControl>
                                <FormDescription>Select a category for the transaction
                                </FormDescription>
                            </FormItem>
                            )}>
                            </FormField>
                            ...
                            <FormField control={form.control} name="date" render={({ field }) => (<FormItem>
                                <FormLabel className="z-1">Transaction Date</FormLabel>
                                <Popover>
                                ...
                                <FormDescription>Select a date for the transaction
                                </FormDescription>
                                <FormMessage />
                            </FormItem>
                            )}>
