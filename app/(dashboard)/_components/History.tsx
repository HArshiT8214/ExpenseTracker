...
function History({ userSettings }: { userSettings: Useretting }) {
    ...
    const historyDataQuery = useQuery({
        ...
        queryFn: () => fetch(`/api/history_data?timeframe=${timeframe}&year=${period.year}&month=${period.month}`).then((res) => res.json()),
    });
...
function CustomTooltip({ active, payload, formatter }: any) {
    ...
    return <div className="min-w-[300px] rounded border bg-ackground p-4">
