            ...
            <Form{...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    <FormField control={form.control} name="name" render={({ field }) => (<FormItem>
                        ...
                        <FormDescription>This is how your category will appear in the app
                        </FormDescription>
                    </FormItem>
                    )}>
                    </FormField>
                    ...
                    <FormField control={form.control} name="icon" render={({ field }) => (<FormItem>
                            ...
                            <Popover>
                                <PopoverTrigger asChild>
                                    <Button variant={"outline"} className="h-[100px] w-full">
                                        {form.watch("icon") ? (<div className="flex flex-col items-center gap-2">
                        ...
                        <FormDescription>This is how your category will apper in the app
                        </FormDescription>
                    </FormItem>
                    )}>
                    </FormField>
